...
func (in *PodResourcePolicy) DeepCopyInto(out *PodResourcePolicy) {
	*out = *in
	...
	if in.ResourceClaimPolicies != nil {
		in, out := &in.ResourceClaimPolicies, &out.ResourceClaimPolicies
		*out = make([]ResourceClaimPolicy, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceClaimPolicy) DeepCopyInto(out *ResourceClaimPolicy) {
	*out = *in
	if in.MinAllowed != nil {
		in, out := &in.MinAllowed, &out.MinAllowed
		*out = make(corev1.ResourceList, len(*in))
	...
	if in.ControlledCapacities != nil {
		in, out := &in.ControlledCapacities, &out.ControlledCapacities
		*out = make([]resourcev1.QualifiedName, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceClaimPolicy.
func (in *ResourceClaimPolicy) DeepCopy() *ResourceClaimPolicy {
	if in == nil {
		return nil
	}
	out := new(ResourceClaimPolicy)
	in.DeepCopyInto(out)
	return out
}
