...
// Interface provides access to all informers in the autoscaling.k8s.io/v1alpha1 group.
...
// New returns a new Interface for the autoscaling.k8s.io/v1alpha1 group.
func New(
...
func (v *version) MultidimPodAutoscalers() MultidimPodAutoscalerInformer {
	return &multidimPodAutoscalerInformer{
		factory:          v.factory,
